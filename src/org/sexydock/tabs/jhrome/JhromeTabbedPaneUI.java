...
public class JhromeTabbedPaneUI extends TabbedPaneUI
{
	...
	private int							maxUniformWidth			= 225;
	 ...
	 * hierarchy. However, the tab will be immediately removed from the list of tabs in this tabbed pane, so {@link #getTabs()}, {@link },
	...
	private int animate( int value , int target , double animFactor , boolean animNeeded )
	{
	...
	private int animateShrinkingOnly( int value , int target , double animFactor , boolean animNeeded )
	{
